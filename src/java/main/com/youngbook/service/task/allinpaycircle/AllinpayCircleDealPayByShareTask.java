 ...
 */
public class AllinpayCircleDealPayByShareTask extends Task {

    AllinpayCircleService allinpayCircleService = Config.getBeanByName("allinpayCircleService", AllinpayCircleService.class);

    public AllinpayCircleDealPayByShareTask() {

        this.setName("AllinpayCircleDealPayByShareTask");
    ...
    public void run() {
        ...
        LogService.console("AllinpayCircleDealPayByShareTask running - Start");
