 ...
 */
public class FdcgCustomerAccountUnbindTask extends Task {

    CustomerAccountService customerAccountService = Config.getBeanByName("customerAccountService", CustomerAccountService.class);

    public FdcgCustomerAccountUnbindTask() {

        this.setName("CustomerAccountUnbindTask");
    ...
    public void run() {
        ...
        while (isRunning) {
            ...
            LogService.console("FdcgCustomerAccountUnbindTask running - Start");
            ...
            try {
                ...
                dbSQL.addParameter4All("name", "用户解绑银行卡-异步回调");
                dbSQL.initSQL();
                ...
                if (responseDataList == null || responseDataList.size() == 0) {
                    System.out.println("FdcgCustomerAccountUnbindTask 完成一次轮询");
                    isRunning = false;
                    continue;
                }
                ...
                if (customerAccountPO != null) {
                    customerAccountService.fdcgUnbind(customerAccountPO, conn);
                }
                ...
                Config.sendMessage("fdcg - FdcgCustomerAccountUnbindTask", e.getMessage());
        ...
        LogService.console("FdcgCustomerAccountUnbindTask running - Stop");
