...
/*        int orderPayChannel = OrderPayChannel.ALLINPAY;
     ...
     * @throws Exception
     */
    public Pager list(OrderVO orderVO, HttpServletRequest request, UserPO user) throws Exception {
        QueryType queryType = new QueryType(Database.QUERY_FUZZY, Database.NUMBER_EQUAL);
        String sql = getSql(request, user);
        Pager pager = Pager.query(sql, orderVO, null, request, queryType);
        return pager;
    }
     ...
     * @throws Exception
     */
    public Pager showListSaleGroup(OrderVO orderVO, String payTimeStart, String payTimeEnd, UserPO user, HttpServletRequest request, Connection conn) throws Exception {


        DatabaseSQL dbSQL = DatabaseSQL.newInstance("showListSaleGroup", this);
        ...
        Pager pager = Pager.search(sbSQL.toString(), dbSQL.getParameters(), orderVO, null, request, queryType, conn);
