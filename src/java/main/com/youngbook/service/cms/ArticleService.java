...
public class ArticleService extends BaseService {
    ...
    public int deleteCircle(String id, Connection conn) throws Exception {
        ...
        if (articlePO != null) {
            MySQLDao.remove(articlePO, conn);
        }
    ...
    public ArticlePO saveArticlePO(String content, String bizId, String columnId, Connection conn) throws Exception {
        ArticlePO articlePO = new ArticlePO();
    ...
    public List<ArticleVO> getListArticleVO(ArticleVO articleVO, Connection conn) throws Exception {
        ...
        List<ArticleVO> list = articleDao.getListArticleVO(articleVO, conn);
    ...
    public Pager getPagerArticleVO(ArticleVO articleVO, int currentPage, int showRowCount, Connection conn) throws Exception {
        ...
        Pager pagerArticleVO = articleDao.getPagerArticleVO(articleVO, currentPage, showRowCount, conn);

        return pagerArticleVO;
    }
