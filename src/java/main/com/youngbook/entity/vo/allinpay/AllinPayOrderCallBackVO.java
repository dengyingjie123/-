package com.youngbook.entity.vo.allinpay;
 ...
 */
@Table(name = "bank_AllinPayCallback", jsonPrefix = "allinPayCallBack")
public class AllinPayOrderCallBackVO extends BaseVO {
    // sid
    @Id
