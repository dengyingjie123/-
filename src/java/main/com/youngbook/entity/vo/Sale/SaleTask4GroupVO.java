...
@Table(name = "sale_SaleTask4Group", jsonPrefix = "saleTask4GroupVO")
public class SaleTask4GroupVO extends BaseVO{
    // sid
    @Id
    ...
    private String productionName = new String();//产品
    private String saleGroupName =new String();//销售小组名称
    //getset
    public int getSid() {
        return sid;
    }
