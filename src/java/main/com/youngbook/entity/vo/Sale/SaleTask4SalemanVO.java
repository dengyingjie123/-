 ...
 */
@Table(name = "sale_saletask4saleman", jsonPrefix = "saleTask4SalemanVO")
public class SaleTask4SalemanVO extends BaseVO  {
    // sid
    @Id
    ...
    private String productionId = new String();// 销售组编号 : 主表关系【SaleTask4Group,SalemanId,SaleGroupId】
    private String saleGroupId = new String();// 销售员编号
    private String salemanId = new String();// 分配金额
    ...
    private String salemanName = new String();//销售人员名称
