 ...
 * 报送资料明细表
 */
@Table(name = "oa_InformationSubmittedItem2", jsonPrefix = "informationSubmittedItem2")
public class InformationSubmittedItem2PO extends BasePO {
    // sid
    @Id
    ...
    //kv组合 对应组名 OA_Information_Group ： 1为其他
