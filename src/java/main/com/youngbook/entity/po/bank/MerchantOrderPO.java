 ...
 * Date 2015-6-3
 */
@Table(name = "bank_MerchantOrder", jsonPrefix = "merchantOrder")
public class MerchantOrderPO extends BasePO {
    ...
    // 订单状态
    private int bankBillStatus = Integer.MAX_VALUE;
    ...
    // 招行校验码ID
    private String merchantCodeId = new String();

    // 请求URL
    private String requestURL = new String();

    public String getMerchantCodeId() {return merchantCodeId;}
    public void setMerchantCodeId(String merchantCodeId) {this.merchantCodeId = merchantCodeId;}
    ...
    public void setBankCono(String bankCono) {this.bankCono = bankCono;}
    ...
    public String getBankClientIP() {return bankClientIP;}
    public void setBankClientIP(String bankClientIP) {this.bankClientIP = bankClientIP;}

    public String getBankGoodsType() {return bankGoodsType;}
    public void setBankGoodsType(String bankGoodsType) {this.bankGoodsType = bankGoodsType;}

    public String getBankId() {return bankId;}
    public void setBankId(String bankId) {this.bankId = bankId;}

    public int getBankBillStatus() {return bankBillStatus;}
    public void setBankBillStatus(int bankBillStatus) {this.bankBillStatus = bankBillStatus;}

    public String getBankReserved() {return bankReserved;}
    public void setBankReserved(String bankReserved) {this.bankReserved = bankReserved;}
