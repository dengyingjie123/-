...
public class CustomerMoneyLogStatus {
    public static final String Successed = "成功";
    public static final String Failed = "失败";
    public static final String Accepted = "受理";
    /**
     * 创建json数组
     * @return
     */
    public static JSONArray toJsonArray() {
        ...
        jArrays.element("id",CustomerMoneyLogStatus.Successed);
        jArrays.element("text",CustomerMoneyLogStatus.Successed);
