...
@Table(name = "crm_customer_outer", jsonPrefix = "customerOuter")
public class CustomerOuterPO extends BasePO {
    ...
    // 身份证号
    private String idCardNo = new String();
    ...
    //客户id
    private String CustomerPersonalId = new String();
