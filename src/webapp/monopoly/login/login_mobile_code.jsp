...
<div class="login_ct">
    ...
    <div class="login_ct_main">
        ...
        <p class="agreement_text">登录即代表同意《<a href="#" onclick="window.location='<%=Config.getWebMonopoly()%>/login/agreement.jsp'">大富翁服务协议</a>》</p>
...
<script type="text/javascript" src="<%=Config.getWebMonopoly()%>/include/js/functions.js"></script>
