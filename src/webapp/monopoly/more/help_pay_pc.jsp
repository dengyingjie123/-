...
<div data-page="help_pay" class="page">
    ...
    <div class="page-content hide-bars-on-scroll">
        ...
        <div class="content-block">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;	当“投资金额”>50000、或选择PC网银支付时<br>
            	身份证号码（必填）<br>
            	推荐码（选填）<br>

            <br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;
            3. 投资金额大于5万时，选择【PC网银支付】
            <br><br>
            <img src="<%=Config.getWebPH()%>/include/img/help004.jpg" style="width:100%; height:100%" />
            &nbsp;&nbsp;&nbsp;&nbsp;
            4. 提交订单后，系统会生成支付码，客户在PC电脑上访问网址 http://pay.dianjinpai.com 完成支付
            <br><br>
            <img src="<%=Config.getWebPH()%>/include/img/help006.jpg" style="width:100%; height:100%" />
            <br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;
            5. 客户在PC电脑上访问网址 http://pay.dianjinpai.com，输入手机号和支付码
            <br><br>
            <img src="<%=Config.getWebPH()%>/include/img/help007.jpg" style="width:100%; height:100%" />
            <br><br>
            6. 核对支付信息，并选择支付银行，调用U盾完成网银支付
            <br><br>
            <img src="<%=Config.getWebPH()%>/include/img/help008.jpg" style="width:100%; height:100%" />
            <br><br>
        </div>
        <div class="content-block">
            &nbsp;
