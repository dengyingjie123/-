 ...
 */
var FinancePayWFAClass = function (token) {
    //设置服务访问地址
    ...
    function onClickFinancePayWFAPrint(buttonId,tableid) {
        ...
        fw.bindOnClick(buttonId, function (process) {
            fw.datagridGetSelected(tableid, function (selected) {
                ...
                var url =WEB_ROOT+"/modules/oa/modelsFiles/FinancePayWFAModels.jsp?id="+selected.id+"&token=" + token;
               window.open(url);
...
//            title: '资金支付管理',
    ...
    function initFinancePayWFAWindow(data, btn) {
        ...
        var url = WebPageUrl + '/FinancePayWFA_Save.jsp?token=' + token;
        var windowId = 'FinancePayWFAWindow' + token;
        fw.window(windowId, '资金支付管理', 550, 550, url, function () {
    ...
    function onClickFinancePayWFASubmit() {
        ...
        fw.bindOnClick(buttonId, function (process) {
            ...
            var url = ActionUrl + '/FinancePayWFA_insertOrUpdate.action?financePayWFAVO.workflowId=6';
