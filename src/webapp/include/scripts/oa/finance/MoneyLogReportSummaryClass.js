 ...
 * @constructor
 */
var MoneyLogReportSummaryClass = function(token) {
...
//        fw.getComboTreeFromKV('search_InOrOut'+token, 'OA_Finance_MoneyLog_InOrOut', 'k','-2');
    ...
    function initTalbeSummaryTreeTable() {
        var strTableId = "MoneyLogReportParentCompanyTreeTable" + token;
        var url = WEB_ROOT+"/oa/finance/MoneyLogReportSummary_listCompany.action";
        $('#'+strTableId).treegrid({
            title: '公司收支表',
            url:url,
            idField:'id',
            ...
            columns:[[
                ...
                { field: 'name', title: '部门', width: 300 },
                { field: 'moneyIn', title: '收入', width: 130 },
                { field: 'moneyOut', title: '支出', width: 130 },
                { field: 'total', title: '合计', width: 130 }
            ]]
        });
