 ...
 */
var HistoryContractClass = function (token) {
    function initAll() {
        initContactSearch();
        //查询
    ...
    function initContractTable() {
        ...
        var url = WEB_ROOT + "/sale/contract/Contract_getListHistoryContract.action";
    ...
    var detailStatus = [{"id": "0", "text": "正常"}, {"id": "1", "text": "遗失"}];
