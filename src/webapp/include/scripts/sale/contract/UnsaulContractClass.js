 ...
 */
var UnsaulContractClass = function (token) {
    function initAll() {
        initUnsaulContactSearch();
        //查询
        onClickUnsaulContractSearch();
        //查询重置
        onClickUnsaulContractSearchReset();
        //表格
        initUnsaulContractTable();
    }

    /**
     * 合同列表
     */
    function initUnsaulContractTable() {
        var strTableId = 'UnsaulContractTable' + token;
        var url = WEB_ROOT + "/sale/contract/Contract_getListUnsualContracts.action";
    ...
    function onClickContractRouteList() {
        ...
        fw.bindOnClick(buttonId, function (process) {
            fw.datagridGetSelected('UnsaulContractTable' + token, function (selecteds) {
    ...
    function onCLickConfirmContract() {
        ...
        fw.bindOnClick(buttonId, function (process) {
            fw.datagridGetSelected('UnsaulContractTable' + token, function (selected) {
                process.beforeClick();
        ...
        fw.bindOnClick(buttonId, function (process) {
            fw.confirm("通知","是否确认合同状态",function(){
                ...
                fw.post(url, null, function (data) {
                    ...
                    if (data == true) {
                        fw.alert("通知", "确认成功");
                        fw.datagridReload("UnsaulContractTable" + token);
     ...
     * 初始化查询
     */
    function initUnsaulContactSearch() {
     ...
     * 查询事件
     */
    function onClickUnsaulContractSearch() {
        var buttonId = "btnSearchUnsaulContract" + token;
        fw.bindOnClick(buttonId, function (process) {
            var strTableId = "UnsaulContractTable" + token;
     ...
     * 查询重置事件
     */
    function onClickUnsaulContractSearchReset() {
        var buttonId = "btnResetUnsaulContract" + token;
        fw.bindOnClick(buttonId, function (process) {
