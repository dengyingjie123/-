 ...
 * @constructor
 */
var paymentPlanStatusSuccessClass = function (token) {
    ...
    function initAll() {
        ...
        // 初始化表格
        initTablePaymentPlanSuccessTable();
    }
     ...
     * 初始化表格
     */
    function initTablePaymentPlanSuccessTable() {
        var strTableId = 'PaymentPlanSuccessTable' + token;//表格ID

        //访问的URLAction
        var url = WEB_ROOT + "/sale/PaymentPlan_getProductionSuccesslist.action";
    ...
    function onClickPaymentPlanSearch() {
        ...
        fw.bindOnClick(buttonId, function (process) {
            var strTableId = "PaymentPlanSuccessTable" + token;
