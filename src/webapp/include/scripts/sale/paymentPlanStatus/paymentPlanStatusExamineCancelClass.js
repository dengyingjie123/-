/**
 * Created by zhouhaihong on 2015/9/11.
 * 兑付成功脚本
 */
 ...
 * @constructor
 */
var paymentPlanStatusExamineCancelClass = function (token) {
    ///  初始化部分 开始  /////////////////////////////////////////////////////////////////
    ...
    function initAll() {
        // 初始化表格
        initTablePaymentPlanCancelTable();

        //初始化列表状态选择查询。
        initProductionHomeSearchForm();//项目列表
        // 初始化查询事件
     ...
     * 初始化表格
     */
    function initTablePaymentPlanCancelTable() {
        var strTableId = 'PaymentPlanCancelTable' + token;//表格ID

        //访问的URLAction
        var url = WEB_ROOT + "/sale/PaymentPlan_getPaymentPlanPagerIsFoCancel.action";
        ...
        $('#' + strTableId).datagrid({
            ...
            toolbar: [
                {
                    id: 'btnPaymentPlanPayCancel' + token,
                    text: '详情',
                    iconCls: 'icon-edit'
                }
            ],
...
///  事件定义 开始  /////////////////////////////////////////////////////////////////
    ...
    function onClickPaymentPlanDetails() {
        var buttonId = "btnPaymentPlanPayCancel" + token;
        fw.bindOnClick(buttonId, function (process) {
            fw.datagridGetSelected('PaymentPlanCancelTable' + token, function (selected) {
                ...
                var data = {
                    ...
                    'totalPaymentMoney': selected.totalPaymentMoney,
                    'paymentTime': selected.paymentTime
                };
    ...
    function onClickPaymentPlanSearch() {
        ...
        fw.bindOnClick(buttonId, function (process) {
            var strTableId = "PaymentPlanCancelTable" + token;
