...
String strDW = (String)session.getAttribute("dangwei");
out.println("<script language='javascript'>");
out.println("var user = '"+strUserName+"';");
out.println("var dw = '"+strDW+"';");
out.println("</script>");
%>
      ...
      <table width="100%"  border="1">
        ...
        <tr>
          <td><p>
              ...
              <input type="button" name="Button" value="修改意见" onClick="getYJ()" disabled>
