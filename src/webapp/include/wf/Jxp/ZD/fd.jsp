...
function submitForm(form) {
  buildTime(form);
  opener.resetTD("FDSJ");
  opener.modifyTD("FDSJ", time);
  opener.resetTD("FDSLR");
  opener.modifyTD("FDSLR", form.FDSLR.value);
  opener.resetTD("FDDDY");
  opener.modifyTD("FDDDY", document.all.FDDDY.innerText);
	opener.updateJxp();
  window.close();
}
...
分</td>
        ...
        <tr class="tdbg">
          <td>受令人</td>
          <td><input name="FDSLR" type="text" id="FDSLR"></td>
        </tr>
        <tr class="tdbg">
          <td>中心调度员</td>
          <td id="FDDDY"><%=strUserName %></td>
        </tr>
        <tr class="tdbg">
