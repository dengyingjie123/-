...
function submitForm(form) {
  buildTime(form);
  opener.resetTD("WGSJ");
  opener.modifyTD("WGSJ", time);
  opener.resetTD("WGSLR");
  opener.modifyTD("WGSLR", form.WGSLR.value);
  opener.resetTD("WGDDY");
  opener.modifyTD("WGDDY", document.all.WGDDY.innerText);
	opener.updateJxp();
  window.close();
}
...
分</td>
        ...
        <tr class="tdbg">
          <td>受令人</td>
          <td><input name="WGSLR" type="text" id="WGSLR"></td>
        </tr>
        <tr class="tdbg">
          <td>中心调度员</td>
          <td id="WGDDY"><%=strUserName %></td>
        </tr>
        <tr class="tdbg">
