...
function submitForm(form) {
  buildTime(form);
  opener.resetTD("KGSJ");
  opener.modifyTD("KGSJ", time);
  opener.resetTD("KGSLR");
  opener.modifyTD("KGSLR", form.KGSLR.value);
  opener.resetTD("KGDDY");
  opener.modifyTD("KGDDY", document.all.KGDDY.innerText);
	opener.updateJxp();
  window.close();
}
...
分</td>
        ...
        <tr class="tdbg">
          <td>受令人</td>
          <td><input name="KGSLR" type="text" id="KGSLR"></td>
        </tr>
        <tr class="tdbg">
          <td>中心调度员</td>
          <td id="KGDDY"><%=strUserName %></td>
        </tr>
        <tr class="tdbg">
