...
function submitForm(form) {
  buildTime(form);
  opener.resetTD("TZSJ");
  opener.modifyTD("TZSJ", time);
  opener.resetTD("TZJLR");
  opener.modifyTD("TZJLR", form.TZJLR.value);
  opener.resetTD("TZR");
  opener.modifyTD("TZR", document.all.TZR.innerText);
	opener.addAllField();
	//opener.updateJxp();
	
	///////////////////////////////
	opener.form.ServiceType.value = "SaveOnly";
  opener.form.TargetURL.value = "/jxp/ZD/tzDone.jsp?CurrNodeID=12&YWID=<%=intID%>";
...
分</td>
        ...
        <tr class="tdbg">
          <td>接令人</td>
          <td><input name="TZJLR" type="text" id="TZJLR"></td>
        </tr>
        <tr class="tdbg">
          <td>通知人</td>
          <td id="TZR"><%=strUserName %></td>
        </tr>
        <tr class="tdbg">
