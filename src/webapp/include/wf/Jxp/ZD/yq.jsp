...
function submitForm(form) {
  buildTime(form);
  opener.resetTD("YQSJ");
  opener.modifyTD("YQSJ", time);
  opener.resetTD("YQSQR");
  opener.modifyTD("YQSQR", form.YQSQR.value);
	opener.resetTD("YQYY");
	opener.modifyTD("YQYY", form.YQYY.value);
  opener.resetTD("YQPZR");
  opener.modifyTD("YQPZR", document.all.YQPZR.innerText);
	opener.updateJxp();
  window.close();
}
      ...
      <table width="100%"  border="0" cellpadding="2" cellspacing="1" class="tablebg">
        ...
        <tr class="tdbg">
          ...
          <td><%=jxp.getSBMC() %></td>
				...
				<tr class="tdbg">
          <td>申请人</td>
          <td><input name="YQSQR" type="text" id="YQSQR"></td>
        </tr>
        <tr class="tdbg">
          <td>延期时间</td>
...
分</td>
        ...
        <tr class="tdbg">
          <td>延期原因</td>
          <td><textarea name="YQYY" cols="40" rows="5" wrap="VIRTUAL" id="YQYY"></textarea></td>
        </tr>
        <tr class="tdbg">
          <td>批准人</td>
          <td id="YQPZR"><%=strUserName %></td>
        </tr>
        <tr class="tdbg">
