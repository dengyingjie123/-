...
if (strActions != null && strActions.equals("ModCondition")) {
  String strIn = request.getParameter("Condition_In");
  String strOut = request.getParameter("Condition_Out");
  //设置节点进入条件
  modNode.setCondition_In(Tools.Encode(Tools.toUTF8(strIn)));
  //设置节点离开条件
  modNode.setCondition_Out(Tools.Encode(Tools.toUTF8(strOut)));

  //保存修改信息后，转向下一页面
  %>
  <jsp:forward page="Node_Mod_FieldStatu.jsp"></jsp:forward>
  <%
  }
  %>
...
function submitForm(form) {
    ...
    form.action = "Node_Mod_Condition.jsp";
    form.submit();
...
<form name="form1" method="post" action="">
      ...
      <div align="center">
        ...
        <table width="585"  border="0" cellpadding="0" cellspacing="0" class="TableINBgStyle">
          <tr>
            <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
              <tr class="TableBgStyle">
                <td width="16%">进入条件：</td>
                <td><textarea name="Condition_In" cols="70" rows="5" wrap="VIRTUAL" id="ConditionIn"><%=Tools.Decode(modNode.getCondition_In())%>
				  </textarea></td>
              </tr>
              <tr class="TableBgStyle">
                <td>离开条件：</td>
                <td><textarea name="Condition_Out" cols="70" rows="5" wrap="VIRTUAL" id="ConditionOut"><%=Tools.Decode(modNode.getCondition_Out())%>
				</textarea></td>
              </tr>
            </table></td>
          </tr>
        ...
        <br>
          <input type="hidden" name="Actions" id="Actions" value="ModCondition"/>
        ...
        <div align="center">
         <table width="585"  border="0" cellpadding="0" cellspacing="1" class="TableINBgStyle">
                <tr class="DateListTableHeadStyle">
				  ...
				  <td width="19%"><div align="center">类型</div></td>
                  <td width="17%"><div align="center">选择条件</div></td>
				  <td width="19%"><div align="center">输入条件</div></td>
				  <td width="15%"><div align="center">关系</div></td>
                </tr>
                ...
                while (itBF.hasNext()) {
                  ...
                  int intID = modNode.getWorkflowID();
