    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            ...
            fw.post(getMd5, "formValue="+formValue, function(data){
                var md5 = data['md5'];
                if (!fw.checkIsTextEmpty(md5)) {
                    $('#md5').val(md5);
                    $('#m').val(md5);
                    $('#string').val(formValue);
...
<body>
<form id="form" name="form" method="post" action="https://pay.fuiou.com/smpGate.do" target="_blank">
    <table width="100%" border="1">
        ...
        <tr>
            <td>银行代码*</td>
            <td><label>
                <input name="iss_ins_cd" type="text" id="iss_ins_cd" value="0803060000" width="300px" />
                广发银行
            </label></td>
        </tr>
        <tr>
            <td>String</td>
            <td><label>
                <input name="string" type="text" id="string" value="" width="300px" />
        ...
        <tr>
            <td>MD5</td>
            <td><label>
                <input name="m" type="text" id="m" value="" width="300px" />
                广发银行
            </label></td>
        </tr>
        <tr>
