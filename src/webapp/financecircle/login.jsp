        ...
        <div class="pages navbar-through">
            ...
            <div data-page="login-screen-embedded" class="page">
                <div class="page-content login-screen-content">
                    ...
                    <div style="margin: 0 auto; width:100%; text-align: center"><img src="<%=Config.getWebDeheSales()%>/include/img/login_logo.png" style="width: 100px;height:100px;" /></div>
                    ...
                    <form>
                            ...
                            <ul>
                                    ...
                                    <div class="item-content">
                                        ...
                                        <div class="item-inner">
                                            <div class="item-input">
                                                <input id="txt-login-mobile" name="mobile" type="text" placeholder="手机号" value="13888939712"/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="item-content">
                                        ...
                                        <div class="item-inner">
                                            <div class="item-input">
                                                <input id="txt-login-password" type="password" name="password" placeholder="密码" value="admin"/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="content-block"><a id="btn-login-password" href="#" class="button button-fill button-raised">登录</a></div>
                        <div>
                            <div class="row">
                                <div class="col-30"><a href="javascript:window.location='<%=Config.getWebDeheSales()%>/login/register.jsp'">免费注册</a></div>
                                <div class="col-50">忘记密码？<a href="javascript:window.location='<%=Config.getWebDeheSales()%>/login/login_mobile_code.jsp'">短信登录</a></div>
                            </div>
                        </div>
