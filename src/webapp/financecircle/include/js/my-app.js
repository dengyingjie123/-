...
function initApp() {
    ...
    viewHome.router.loadPage(WEB_ROOT + '/dehesales/loadPage_deheSales_home_list?columnId=16D15C9FA5FB4702B161E1A951E810D0&r');
    ...
    $$('a').on('click', function (e) {
        ...
        if (id == 'btn-view-customer') {
            viewCustomer.router.loadPage(WEB_ROOT + '/dehesales/loadPage_deheSales_customer_list');
        ...
        if (id == 'btn-view-5') {
            // viewMine.router.loadPage('mine/mine_list.jsp?r='+Math.random());
            viewMine.router.loadPage(WEB_ROOT + "/circle/loadPage_ph_mine_list");
...
$$('#btn-login-register').on('click',function (e) {
    ...
    $$.post(url, formData, function (data) {
        ...
        if (data.code == 100) {
            window.location = WEB_ROOT + "/dehesales/index.jsp?r="+Math.random();
        }
