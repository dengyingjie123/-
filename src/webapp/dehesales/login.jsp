        ...
        <div class="pages navbar-through">
            ...
            <div data-page="login-screen-embedded" class="page">
                <div class="page-content login-screen-content">
                    ...
                    <div style="margin: 0 auto; width:100%; text-align: center"><img src="<%=Config.getWebDeheSales()%>/include/img/login_logo.png" style="width: 100px;height:107px;" /></div>
                    ...
                    <form>
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-40"><a href="javascript:window.location='<%=Config.getWebDeheSales()%>/login/login_mobile_code.jsp'">新老用户短信登录</a></div>
                            </div>
                        </div>
...
<script type="text/javascript" src="<%=Config.getWebDeheSales()%>/include/framework/framework7-1.6.5/js/framework7.js"></script>
<!-- Path to your app js-->
