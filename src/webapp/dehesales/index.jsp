...
<html>
  ...
  <body>
    ...
    <div class="views tabs toolbar-through">
      ...
      <!-- -->
      <%--<div id="view-mine" class="view tab <%=show.equals("2")?"active":""%>">--%>


        <%--<div class="pages navbar-fixed">--%>
          <%--<div data-page="index-mine" class="page">--%>
      ...
      <div id="mainToolbar" class="toolbar tabbar tabbar-labels toolbar-ph">
        <div class="toolbar-inner">
          ...
          <a id="btn-view-2" href="#view-market" class="tab-link <%=show.equals("1")?"active":""%>"><i class="icon tabbar-index-icon-market"></i><span class="tabbar-label">产品</span></a>
          ...
          <%--<a id="btn-view-mine" href="#view-mine" class="tab-link <%=show.equals("2")?"active":""%>"> <i class="icon tabbar-index-icon-mine"></i><span class="tabbar-label">我的账户</span></a>--%>
            <a id="btn-view-customer" href="#view-customer" class="tab-link"> <i class="icon tabbar-index-icon-mine"></i><span class="tabbar-label">客户</span></a>
        </div>
      </div>
    </div>
    <!-- Path to Framework7 Library JS-->
    <script type="text/javascript" src="<%=Config.getWebDeheSales()%>/include/js/pages.js?r=<%=NumberUtils.randomNumbers(5)%>"></script>
    <script type="text/javascript" src="<%=Config.getWebDeheSales()%>/include/js/my-app.js?r=<%=NumberUtils.randomNumbers(5)%>"></script>
    <script type="text/javascript" src="<%=Config.getWebDeheSales()%>/include/js/checkLogin.js?r=<%=NumberUtils.randomNumbers(5)%>"></script>
    <script type="text/javascript" src="<%=Config.getWebDeheSales()%>/include/js/functions.js?r=<%=NumberUtils.randomNumbers(5)%>"></script>
  </body>
<script type="text/javascript">
