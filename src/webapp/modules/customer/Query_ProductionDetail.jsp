                    ...
                    <div title="产品信息" style="padding:5px ;">
                        <table border="0" id="ProductionInfoTable_Description<%=token%>"
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="easyui-validatebox" id="InvestTerm<%=token%>" name="production.investTerm" data-options="required:true,validType:'number'" invalidMessage="请输入大于等于零的整数" style="width: 300px"/>天
                                </td>
                            </tr>
                            <tr>
