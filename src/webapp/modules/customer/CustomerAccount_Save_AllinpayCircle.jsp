...
<div class="easyui-layout" fit="true">
    <div region="center" border="false" style="padding:10px;background:#fff;border:0px solid #ccc;">
        <form id="formCustomerAccount<%=token %>" name="formCustomerAccount" action="" method="post">
            ...
            <table width="100%" border="0" cellspacing="5" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><input  type="text" id="bank<%=token %>" class="easyui-combotree" name="customerAccount.bank"  style="width:200px"/></td>
                </tr>
                <tr>
                    <td align="right">原账户名称</td>
      ...
      <input type="hidden" id="bankCode<%=token %>"  class="easyui-validatebox"  name="customerAccount.bankCode"  style="width:200px"/>
            ...
            <input type="hidden" id="bankBranchName<%=token %>"  class="easyui-validatebox"   name="customerAccount.bankBranchName"  style="width:200px"/>
            <input type="hidden" id="cityCode<%=token %>"  class="easyui-validatebox"   name="customerAccount.cityCode"  style="width:200px"/>
        </form>
    </div>
