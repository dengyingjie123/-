    ...
    <div class="easyui-panel" title="查询" iconCls="icon-search">
        <table border="0" cellpadding="3" cellspacing="0">
            <tr>
                ...
                <td>
                    <a id="btnSearchInformationSubmitted2<%=token %>" href="javascript:void(0)" class="easyui-linkbutton"
                       iconCls="icon-search">查询</a>
                </td>
                <td>
                    <a id="btnResetInformationSubmitted2<%=token %>" href="javascript:void(0)" class="easyui-linkbutton"
    ...
    <div style='height: 500px;width:auto'  >
        <div id="InformTab<%=token%>" class='easyui-tabs' fit='true' border='true' style='overflow:auto;'>
            <div title='我的申请' style='padding:5px'>
                <table id="InformationSubmitted2Table<%=token%>"></table>
            </div>
            <div title='等待我审批' style='padding:5px'>
                <table id="WaitInformationSubmitted2Table<%=token%>"></table>
            </div>
            <div title='已完成' style='padding:5px'>
                <table id="ParticipantInformationSubmitted2Table<%=token%>"></table>
            </div>
        </div>
    </div>
</div>
