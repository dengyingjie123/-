        ...
        <form id='formSms<%=token %>' name='formSms' action='' method='post'>
            <table border='0' cellspacing='5' cellpadding='0'>
                ...
                <tr>
                    ...
                    <td><input  type="text" class='easyui-validatebox' id="receiverName<%=token %>" name="sms.receiverName"  required="true" missingmessage="必须填写"   style="width:200px"/></td>
                ...
                <tr>
                    ...
                    <td><input  type="text" class='easyui-datetimebox' id="receiveTime<%=token %>" name="sms.receiveTime"   readonly="readonly"    style="width:200px"/></td>
                </tr>
                <tr>
