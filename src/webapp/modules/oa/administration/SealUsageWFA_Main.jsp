    ...
    <div class="easyui-panel" title="查询" iconCls="icon-search">
        <table border="0" cellpadding="3" cellspacing="0">
            <tr>
                ...
                <td>
                    <a id="btnSearchSealUsageWFA<%=token %>" href="javascript:void(0)" class="easyui-linkbutton"
                       iconCls="icon-search">查询</a>
                </td>
                <td>
                    <a id="btnResetSealUsageWFA<%=token %>" href="javascript:void(0)" class="easyui-linkbutton"
    ...
    <div style='height: 500px;width:auto'  >
        <div class='easyui-tabs' fit='true' border='true' style='overflow:auto;'>
            <div title='我的申请' style='padding:5px'>
                <table id="SealUsageWFATable<%=token%>"></table>
            </div>
            <div title='等待我审批' style='padding:5px'>
                <table id="WaitSealUsageWFATable<%=token%>"></table>
            </div>
            <div title='已完成' style='padding:5px'>
                <table id="ParticipantSealUsageWFATable<%=token%>"></table>
            </div>
        </div>
    </div>
</div>
