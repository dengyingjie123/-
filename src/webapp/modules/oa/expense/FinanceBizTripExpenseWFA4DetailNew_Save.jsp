...
<div class='easyui-layout' fit='true'>
    <div region='center' border='false' style='padding:10px;background:#fff;border:0px solid #ccc;'>
        <form id='formFinanceBizTripExpenseWFATable<%=token %>' name='formFinanceBizTripExpenseWFATable' action='' method='post'>
            ...
            <div style='height: 200px' id="financeBizTripDIV<%=token%>">
        ...
        <!-- HOPEWEALTH-1360 -->
        <div id="panelTripExpenseWorkflow<%=token%>" class="easyui-panel" title="业务流转"
             style="width:560px;height:250px;padding:10px;background:#fafafa;">
        </div>
    ...
    <div region='south' border='false' style='text-align:right;padding:5px;background:#F4F4F4'>
        ...
        <a id="btnFinanceBizTripExpenseWFABizRouteSubmit<%=token %>" class="easyui-linkbutton" iconCls="icon-ok"
           href="javascript:void(0)">同意</a>
        <a id="btnFinanceBizTripExpenseWFABizRouteOver<%=token %>" class="easyui-linkbutton" iconCls="icon-ok"
           href="javascript:void(0)">完成</a>
        <a id="btnFinanceBizTripExpenseWFABizRouteReject<%=token %>" class="easyui-linkbutton" iconCls="icon-cancel"
           href="javascript:void(0)">回退</a>
        <a id="btnFinanceBizTripExpenseWFABizRouteCancel<%=token %>" class="easyui-linkbutton" iconCls="icon-cancel"
