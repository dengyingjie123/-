...
<div region="center" border="false" style="padding:10px;background:#fff;border:0px solid #ccc;">
    <form id="formFinanceExpense<%=token %>" name="formFinanceExpense" action="" method="post">
        ...
        <table id="FinanceExpenseDetailTable<%=token%>" style="height: 200px;width:600px;"></table>
    ...
    <br/>
    <!-- HOPEWEALTH-1385 -->
    <div id="panelFinanceExpenseWorkflow<%=token%>">
    </div>
...
<div region="south" border="false" style="text-align:right;padding:5px;background:#F4F4F4">
    ...
    <a id="btnFinanceExpenseBizRouteSubmit<%=token %>" class="easyui-linkbutton" iconCls="icon-ok"
       href="javascript:void(0)">同意</a>
    <a id="btnFinanceExpenseBizRouteOver<%=token %>" class="easyui-linkbutton" iconCls="icon-ok"
       href="javascript:void(0)">完成</a>
    <a id="btnFinanceExpenseBizRouteReject<%=token %>" class="easyui-linkbutton" iconCls="icon-cancel"
       href="javascript:void(0)">回退</a>
    <a id="btnFinanceExpenseBizRouteCancel<%=token %>" class="easyui-linkbutton" iconCls="icon-cancel"
