...
<div class="easyui-layout" fit="true">
  <div region="center" border="false" style="padding:10px;background:#fff;border:0px solid #ccc;">
    ...
    <div id="panelFinancePayWFAWorkflow<%=token%>">
  ...
  <div region="south" border="false" style="text-align:right;padding:5px;background:#F4F4F4">
    ...
    <a id="btnFinancePayWFABizRouteSubmit<%=token %>" class="easyui-linkbutton" iconCls="icon-ok"
       href="javascript:void(0)">同意</a>
    <a id="btnFinancePayWFABizRouteOver<%=token %>" class="easyui-linkbutton" iconCls="icon-ok"
       href="javascript:void(0)">完成</a>
    <a id="btnFinancePayWFABizRouteReject<%=token %>" class="easyui-linkbutton" iconCls="icon-cancel"
       href="javascript:void(0)">回退</a>
    <a id="btnFinancePayWFABizRouteCancel<%=token %>" class="easyui-linkbutton" iconCls="icon-cancel"
