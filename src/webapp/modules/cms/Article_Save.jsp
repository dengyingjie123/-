        ...
        <form id="formArticle<%=token %>" name="formArticle" action="" method="post">
            <table width="100%" border="0" cellspacing="5" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><input  type="text" id="score<%=token %>" class="easyui-validatebox" name="article.score"  style="width:200px"/></td>
                    <td align="right">缩略图</td>
                    <td><input  type="text" id="image<%=token %>" class="easyui-validatebox" name="article.image"  style="width:200px"/></td>
                </tr>
            </table>
