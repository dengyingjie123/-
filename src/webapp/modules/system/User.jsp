...
<%
    ...
    ButtonPO btnDismiss = new ButtonPO("btnUserDismiss" + token, "离职", "icon-remove","系统管理-用户管理-删除");
// 创建Toolbar，并受权限控制
...
<div style="padding:5px;">
    ...
    <br />
    <table id="UserTable<%=token%>" data-options="toolbar:toolbar"></table>
