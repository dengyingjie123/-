...
<body>
<form id="formUser<%=token%>" name="formUser" action="" method="post">
            ...
            <div style="height: 263px" align="center">
                <table border="0" cellspacing="5" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td><input class="easyui-validatebox" type="text" id="weChatId<%=token %>2" name="user.weChatId" style="width:150px"/></td>
                      <td align="right">&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                </table>
...
<div region="south" border="false" style="text-align:right;padding:6px;background:#F4F4F4">
    <a id="btnUserSubmit<%=token %>" class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" >确定</a>
    <a class="easyui-linkbutton" iconCls="icon-cancel" href="javascript:void(0)" onClick="fwCloseWindow('UserWindow<%=token%>')">取消</a>
</div>
</body>
</html>
