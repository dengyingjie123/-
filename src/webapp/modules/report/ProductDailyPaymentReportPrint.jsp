<%@ page import="com.youngbook.service.report.ProductDailyPaymentReportService" %>
<%@ page import="java.sql.Connection" %>
<%@ page import="com.youngbook.common.config.Config" %>
<%@ page import="com.youngbook.entity.vo.report.ProductDailyPaymentReportVO" %>
...
<%
    ...
    try {
        ...
        List<ProductDailyPaymentReportVO> list = productDailyPaymentReportService.list(time, conn);
%>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
    <tr>
        <td colspan="11" style="text-align:center;"><strong>厚币通宝每日产品兑付金额表</strong></td>
    </tr>
    <tr>
    ...
    %>
    <tr>
        <td align="center"><%=list.get(i).getProductionName()%>
        </td>
