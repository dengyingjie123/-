...
<%
    ...
    menuToolbar.newMenuButton("Sale"+token, "下单", IconStyle.ICON_005, menuToolbarIndex++)
            .addButton("btnOrderSaleAndWaiting" + token, "添加", IconStyle.BLANK, 1, "订单管理2_订单管理2_添加")
            .addButton("btnOrderEdit" + token, "修改", IconStyle.BLANK, 2, "订单管理2_订单管理2_修改")
            .addButton("btnOrderSaleAndWaitingCancel"+token, "作废", IconStyle.BLANK, 3, "订单管理2_订单管理2_作废");
...
//            .addButton("btnOrderAppointmentCancel"+token, "取消预约", IconStyle.BLANK, 2, "订单管理2_订单管理2_预约");
    ...
    menuToolbar.newMenuButton("Finance" + token, "财务操作", IconStyle.ICON_059, menuToolbarIndex++)
            .addButton("btnFinanceConfirm01" + token, "财务一次核对", IconStyle.BLANK, 1, "销售管理_订单管理_财务核对")
            .addButton("btnFinanceConfirm02" + token, "财务二次核对", IconStyle.BLANK, 2, "销售管理_订单管理_财务二次核对")
            .addButton("btnOrderTransfer"+token, "产品转让", IconStyle.BLANK, 3, "销售管理_订单管理_财务核对")
            .addButton("btnOrderPayback"+token, "产品兑付", IconStyle.BLANK, 4, "销售管理_订单管理_财务核对")
            .addButton("btnMoneyTransfer2Gongda" + token, "确认并转账到公达", IconStyle.BLANK, 5, "销售管理_订单管理_转账到公达");
