    ...
    <div class="easyui-panel" title="查询" iconCls="icon-search">
        <table border="0" cellpadding="3" cellspacing="0">
            <tr>
                ...
                <td>
                    <input type="text" class="easyui-datebox" name="mainTableVO_a5_Start" id="Search_A5_Start<%=token%>"
                ...
                <td>
                    <input type="text" class="easyui-datebox" name="mainTableVO_a5_End" id="Search_A5_End<%=token%>"
                           editablt="true" style="width:100px;"/>
                </td>
                <td>
                    开始A6
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="easyui-validatebox" name="mainTableVO.a1" id="search_A1<%=token%>" style="width:100px;"/>
                </td>
                <td>
                    A2
                </td>
                <td>
                    <input type="text" class="easyui-validatebox" name="mainTableVO.a2" id="search_A2<%=token%>" style="width:100px;"/>
                </td>
                <td>
                    A3
                </td>
                ...
                <td>
                    <input type="text" class="easyui-validatebox" data-optioins="validType:'intOrFloat'" name="mainTableVO.a4" id="search_A4<%=token%>" style="width:100px;"/>
                </td>
                <td>
