...
<div style="padding:5px;">
        ...
        <table border="0" cellpadding="3" cellspacing="0">
            <tr>
                ...
                <td><input type="text" class="easyui-combotree" id="search_Type<%=token %>" style="width:150px;"
                           editable="false"/></td>
                <td>兑付状态</td>
                <td><input type="text" class="easyui-combotree" id="search_statusInfo<%=token %>" style="width:150px;"
                           editable="false"/></td>
                <td>开始兑付日期</td>
            ...
            <td>
                <a id="btnResetPaymentPlan<%=token %>" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cut">重置</a>
    ...
    <br>
    <table id="PaymentInfoTable<%=token%>"></table>
