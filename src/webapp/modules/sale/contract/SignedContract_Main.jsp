...
<%
  ...
  ButtonPO btnConfirmContract = new ButtonPO("btnConfirmContract" + token, "状态确认并移交管理员", "icon-add", "签约销售合同_签约销售合同_确认移交");
  ButtonPO btnListContractRouteList = new ButtonPO("btnListContractRouteList" + token, "查看合同流转", "icon-edit", "签约销售合同_签约销售合同_查看状态");
  // 创建Toolbar，并受权限控制
...
<div style="padding:5px;">
  ...
  <div class="easyui-panel" title="查询" iconCls="icon-search">
    <table border="0" cellpadding="3" cellspacing="0">
      <tr>
        ...
        <td>
          <a id="btnSearchSignedContract<%=token %>" href="javascript:void(0)" class="easyui-linkbutton"
             iconCls="icon-search">查询</a>
        </td>
        <td>
          <a id="btnResetSignedContract<%=token %>" href="javascript:void(0)" class="easyui-linkbutton"
  ...
  <br>
  <table id="SignedContractTable<%=token%>" data-options="toolbar:toolbar"></table>
