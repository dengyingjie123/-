                    ...
                    <form id="form-login-mobile-code" name="form_login_mobile_code">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-30"><a href="javascript:window.location='<%=Config.getWebPH()%>/login.jsp'">密码登录</a></div>
                            </div>
                        </div>
                        ...
                        <input id="_s" name="_s" type="hidden" value="3" />
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="<%=Config.getWebPH()%>/include/js/functions.js"></script>
