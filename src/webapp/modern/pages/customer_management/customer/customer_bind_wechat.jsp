    ...
    <script>
        function goto(type) {
            ...
            if (type == 0) {
                ...
                url = "<%=Config.getWebRoot()%>/modern/pages/login_customer.jsp?userType=customer";
				url += "&userInfoId=<%=userInfoId%>";
            }
            else if (type == 2) {
...
<body>
    <div>
        <div class="rgt-hd">
            ...
            <h3 class="register-name">账户绑定</h3>
        </div>
        <section class="customer-details">
            <div class="home-recommend-ct">
                ...
                <ul class="cutmer-data lbBox nth-childtwo pd25">
                    <li onClick="goto(0)">
                        ...
                        <em class="myitem-txt lineBlock">通过验证手机号绑定</em>
                    ...
                    <li onClick="goto(2)">
                        <i class="wait-ico1 cstmer lineBlock"></i>
                        <em class="myitem-txt lineBlock">还没有账户，我要注册</em>
                        <i class="icon-arrow"></i>
            ...
            <div class="home-recommend-ct">
                ...
                <div class="pro-hights pd25">
                    ...
                    <div>
                        <button type="button" class="logout" onClick="fm.goto('<%=Config.getModernCustomerManagementPages()%>/customer/customer_wechat_loginAsGuest.jsp?userInfoId=<%=userInfoId%>');">暂不绑定，我先看看</button>
                    </div>
                </div>
            </div>
        </section>
