...
<head>
    ...
    <script type="text/javascript">
        function register() {
            ...
            var password = $('#personalPassword').val();
            ...
            var parameters = $("form").serialize() + "&personal.password="+fm.getMD5(password);

            var url = "<%=Config.getWebRoot()%>/modern/c/customer/registerModern";
...
//        }
        ...
        function login() {
            fm.goto('<%=Config.getWebRoot()%>/modern/pages/login_customer.jsp');
        }
    </script>
...
<body ng-app="myApp" ng-controller="myCtrl">
    <div class="easyui-navpanel">
        ...
        <div class="rgt-hd">
            ...
            <h3 class="register-name">投资者注册</h3>
        </div>
        <div>&nbsp;</div>
        <div style="padding:0 20px">
            <div style="margin-bottom:10px">
                <input name="personal.mobile" class="easyui-textbox" data-options="prompt:'手机号（必填）',iconCls:'icon-man'" style="width:100%;height:38px" value="">
            </div>
            <div style="margin-bottom:10px">
            ...
            <div style="margin-bottom:10px">
                <input id="personalPassword" name="personal.password1" class="easyui-passwordbox" data-options="prompt:'密码（必填）'" style="width:100%;height:38px">
            </div>
            <div style="margin-bottom:10px">
                <input name="personal.name" class="easyui-textbox" data-options="prompt:'姓名（必填）',iconCls:'icon-man'" style="width:100%;height:38px">
            </div>
            <%--<div style="margin-bottom:10px">--%>
                <%--<input name="idCard" class="easyui-textbox" data-options="prompt:'身份证号',iconCls:'icon-man'" style="width:100%;height:38px">--%>
            <%--</div>--%>
            <div style="margin-bottom:10px">
                <input name="referralCode" class="easyui-textbox" data-options="prompt:'推荐码（选填）',iconCls:'icon-man'" style="width:100%;height:38px">
            </div>
            <div style="text-align:center;margin-top:30px">
                <a href="#" class="easyui-linkbutton c1" style="width:60%;height:35px" onclick="register();"><span style="font-size:16px">提交</span></a>
