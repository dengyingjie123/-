...
<head>
    ...
    <script type="text/javascript">
        ...
        app.controller('myCtrl', function($scope, $http) {
            ...
            $scope.shareLogin = function(){
                fm.goto("<%=Config.getWebRoot()%>/modern/pages/common/login/customer_login_mobile_code.jsp");
            }
        });
    </script>
</head>
...
<div class="easyui-navpanel">
    <div class="header-all">
        <span class="hd-news">
            <span class="hd-cfact-search" ng-click="shareLogin();"><img src="<%=Config.getWebRoot()%>/modern/images/share-wechat.png"></span>
        </span>
        <h3>我的客户</h3>
