...
<head>
    ...
    <script type="text/javascript">
        function gotoSaleManagementIndex() {
            fm.goto('<%=Config.getModernSaleManagementPages()%>/sale_management_index.jsp');
        }
    </script>
</head>
<body>
<div class="easyui-navpanel" ng-app="myApp" ng-controller="myCtrl">
    <section class="aboutus-ct">
        ...
        <div class="aboutus-items">
            ...
            <div class="company-info" onclick="gotoSaleManagementIndex()">
                <div class="items clearfix">
                    <span class="aboutusbg-ico1 ico"></span>
                    <div class="text">管理入口</div>
                </div>
            </div>
        </div>
    </section>
