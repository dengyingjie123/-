...
<head>
    ...
    <script type="text/javascript">
        ...
        function initTableCustomerTable() {
            ...
            var url = "<%=Config.getWebRoot()%>/modern/s/report/SimpleReport_getReport.action?reportName=listReportPaymentPlanMonth";
            url += "&titleConfigString=PaymentPlan_Month";
            ...
            fm.post(url, null, function(data){
                ...
                $('#' + strTableId).datagrid({
                    ...
                    onClickRow:function(index, row){
                        var month = row['PaymentTime'];
                        // alert(JSON.stringify(month));
                        fm.goto('<%=Config.getModernSaleManagementPages()%>/report/report_payment_plan_production_month.jsp?month='+month);
                    }
                });
