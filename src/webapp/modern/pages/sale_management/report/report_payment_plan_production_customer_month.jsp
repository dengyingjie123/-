...
<head>
    ...
    <script type="text/javascript">
        ...
        function initTableCustomerTable() {
            ...
            var url = "<%=Config.getWebRoot()%>/modern/s/report/SimpleReport_getReport.action?reportName=listReportPaymentPlan_Production_Customer_Month";
            url += "&titleConfigString=PaymentPlan_Production_Customer_Month";
            url += "&p=month%3d<%=month%>%26productionId%3d<%=productionId%>";
            ...
            fm.post(url, null, function(data){
                ...
                $('#' + strTableId).datagrid({
                    ...
                    onClickRow:function(index, row){
                        // fm.goto('<%=Config.getModernSaleManagementPages()%>/report/report_payment_plan_production_month.jsp');
                    }
                });
