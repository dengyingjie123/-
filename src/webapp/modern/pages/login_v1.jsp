    ...
    <div>
        ...
        <div style="padding:0 10px">
            ...
            <div style="text-align:center;">
                ...
                <a href="#" id="wechatLoginButton" class="easyui-linkbutton c5" plain="true" outline="true" style="width:28%;height:35px;font-size:.5rem" onClick="wechatLogin()"><span style="font-size:16px;">微信登录</span></a>
            </div>
            <div id="userTypeDiv" class="box-ct">
                <%--<div class="rgttel-ico"></div>--%>
                <%--<i class="ct-hx"></i>--%>
                <div class="sel-box">
