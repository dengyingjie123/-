    ...
    <div>
        ...
        <section class="customer-details">
            <div class="home-recommend-ct">
                <h3 class="tit"><i class="sjx-ico1"></i><i class="triangle-right"></i>请选择</h3>
                <ul class="cutmer-data lbBox nth-childtwo pd25">
                    <li onclick="fm.goto('<%=Config.getModernCustomerManagementPages()%>/customer/customer_register.jsp');">
                        <i class="wait-ico1 cstmer lineBlock"></i>
                        <em class="myitem-txt lineBlock">我是投资者</em>
                        <i class="icon-arrow"></i>
                    </li>
                    <li ng-click="showInfo()">
                        <i class="wait-ico1 cstmer lineBlock"></i>
                        <em class="myitem-txt lineBlock">我是理财经理</em>
                        <i class="icon-arrow"></i>
