...
<%
    ...
    if(statuspo.getAccountStatus() !=1){
        request.getRequestDispatcher("/w2/modules/customer/getCustomerCertificate").forward(request,response);
        return;
    }
        ...
        <form class="form-horizontal" id="coedform" action="<%=Config.getWebRoot()%>/w2/customer/authenticationindCard" method="post">
            <table>
                <tr>
                    ...
                    <input type="text" class="myinput-control myinput-controlWH" style="background: #f1f1f1" onblur="checkCardHolder()" id="cardHolder" placeholder="请输入持卡人" name="customerAccount.name" value="<%=realName%>" readonly="readonly" /></td>
                ...
                <%--<tr>--%>
                    ...
                    <%--<input type="text" class="myinput-control myinput-controlWH" name="realId" maxlength="18"  onblur="identityCardCheck()"--%>
                           <%--id="realId">--%>
                <%--</td>--%>
                ...
                <tr>
                    ...
                    <input type="text" class="myinput-control myinput-controlWH" onblur="checkBankNumber()"
                           id="bankNumber" placeholder="请输入卡号" maxlength="19"  name="customerAccount.number">
                </td>
                ...
                <tr>
                    ...
                    <select class="myinput-control" name="customerAccount.bankCode" id="bankList">
