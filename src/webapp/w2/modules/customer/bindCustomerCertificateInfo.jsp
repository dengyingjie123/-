            ...
            <table>
                ...
                <tr>
                    ...
                    <input type="text" class="myinput-control myinput-controlWH" onblur="checkBankNumber()"
                           id="bankNumber"   maxlength="19"  name="customerAccount.number">
                </td>
                ...
                <tr>
                    ...
                    <td style="padding: 0px 0px 0px 30px;">
                        <input type="button" class="btns-mynext" style="margin-top: 10px;"  id="bankCardSubmmitButton" onclick="customerAccountSubmit()"  value="绑定银行卡" >
                    </td>
                    <td/>
                </tr>
            </table>
