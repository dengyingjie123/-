...
<div id="container" class="w1200"  style="margin-top: -42px;">
    ...
    <div id="title">实名认证与银行卡绑定</div>
    <div id="content">
        <form class="form-horizontal" id="coedform" method="post">
            <table>

                <input type="hidden" id="customerId" name="customerId" value="<%=loginUser.getId()%>" />
                <input type="hidden" id="mobile" name="mobile" value="<%=loginUser.getMobile()%>" />
`
                <tr>
                    <td align="right">持卡人</td><td style="padding: 0px 0px 0px 30px;">
                    <input type="text" class="myinput-control myinput-controlWH"   onblur="checkCardHolder()" id="cardHolder" placeholder="请输入姓名" name="name" value="<%=accountName == null ? "" : accountName%>" style="<%=accountName == null ? "" : "background:#f1f1f1"%>" <%=accountName == null ? "" : "readonly='readonly'"%>  style="width: 300px;"/></td>
                ...
                <tr>
                    ...
                    <input type="text" class="myinput-control myinput-controlWH" name="idCard" maxlength="18"  onblur="identityCardCheck()" placeholder="请输入身份证" value="<%=idCardNumber == null ? "" : idCardNumber%>" style="<%=idCardNumber == null ? "" : "background:#f1f1f1"%>" <%=idCardNumber == null ? "" : "readonly='readonly'"%> id="realId" style="width: 300px;">
                </td>
                ...
                <tr>
                    ...
                    <input type="text" class="myinput-control myinput-controlWH" onblur="checkBankNumber()"
                           id="bankNumber" placeholder="请输入卡号" maxlength="19"  name="bankCard" style="width: 275px;">
                </td>
                ...
                <tr>
                    ...
                    <select class="myinput-control" name="bankCode" id="bankList" style="width: 300px;">
                ...
                <tr>
                    <td align="right">预留手机号</td><td style="padding: 0px 0px 0px 30px;">
                    <input type="text" class="myinput-control myinput-controlWH" onblur="checkMobile()" id="reservedMobile" placeholder="预留手机号" maxlength="19"  name="reservedMobile" style="width: 275px;">
                </td>
                    <td>&nbsp;&nbsp;<span class="m-tip" id="mobileTip" style="font-weight: bold">动态码会发送您注册的手机上：<%=loginUser.getMobile()%></span></td>
                </tr>

                <tr>
                    <td align="right">手机动态码</td><td style="padding: 0px 0px 0px 30px;">
                        <input type="text" class="myinput-control myinput-controlWH" onblur="checkBankNumber()"
                               id="mobileCode" placeholder="手机动态码" maxlength="19"  name="mobileCode" style="width: 275px;">
                    </td>
                    <td>&nbsp;&nbsp;
                        <button type="button" class="btns-code btns-myprimary" id="code" style="width: 105px; height: 30px;" onclick="mobileRegisterCode('reservedMobile')">获取动态码</button>
                    </td>
                </tr>
