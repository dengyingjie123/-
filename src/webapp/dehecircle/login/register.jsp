            ...
            <div data-page="login-register" class="page">
                <div class="page-content login-screen-content">
                    ...
                    <form id="login-register-form">
                        ...
                        <div class="content-block"><a id="btn-login-register" href="#" class="button button-fill color-01 button-raised">注册</a></div>
                        <div class="content-block">
                            <div class="list-block-label">
                                <div class="row">
                                    <div class="col-30"></div>
                                    <div class="col-50">已有账号？
                                        <a href="javascript:window.location='<%=Config.getWebPH()%>/login.jsp'">登录</a>
                                    </div>
