...
<head>
    ...
    <link rel="stylesheet" href="<%=Config.getWebDehecircle()%>/include/framework/framework7-1.6.5/css/framework7.material.css">
    <link rel="stylesheet" href="<%=Config.getWebDehecircle()%>/include/framework/framework7-1.6.5/css/framework7.material.colors.css">
        ...
        <div class="pages navbar-through">
            ...
            <div data-page="login-mobile-code" class="page">
                <div class="page-content login-screen-content">
                    ...
                    <div style="margin: 0 auto; width:100%; text-align: center"><img src="<%=Config.getWebDehecircle()%>/include/img/login_logo.png" style="width: 100px;height:107px;" /></div>
                    ...
                    <form id="form-login-mobile-code" name="form_login_mobile_code">
                            ...
                            <ul>
                                    ...
                                    <div class="item-content">
                                        ...
                                        <div class="item-inner">
                                            <div class="item-input">
                                                <input name="mobile" type="number" pattern="\d*" placeholder="手机号" value="138889397"/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="item-content">
                                        ...
                                        <div class="item-inner">
                                            <div class="item-input">
                                                <input name="mobileCode" type="number" pattern="\d*" placeholder="请输入短信验证码" value="000000"/>
                                            </div>
                                        </div>
                                        <div class="item-inner">
                                            <div class="item-input">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-30"><a href="javascript:window.location='<%=Config.getWebDehecircle()%>/login.jsp'">密码登录</a></div>
                            </div>
                        </div>
                        <div style="position:absolute;bottom:0;width:100%;height:100px;background-image: url(<%=Config.getWebDehecircle()%>/include/img/login_footer_bg.png);background-repeat:no-repeat;background-position:center;background-size: 100% auto"></div>
...
<script type="text/javascript" src="<%=Config.getWebDehecircle()%>/include/framework/framework7-1.6.5/js/framework7.min.js"></script>
<!-- Path to your app js-->
