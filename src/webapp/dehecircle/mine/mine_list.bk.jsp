...
%>
<div data-page="mine-list-bk" class="page">
  ...
  <div class="page-content">
    ...
    <div class="list-block">
      <ul>
        <li><a href="<%=Config.getWebDehecircle()%>/mine/order_catalog.jsp?r=<%=NumberUtils.randomNumbers(5)%>" class="item-link">
        ...
        <li><a href="<%=Config.getWebDehecircle()%>/mine/mine_info.jsp?r=<%=NumberUtils.randomNumbers(5)%>" class="item-link">
          <div class="item-content">
        ...
        <li><a href="<%=Config.getWebDehecircle()%>/loadPage_dehecircle_mobile_list?r=<%=NumberUtils.randomNumbers(5)%>" class="item-link">
          <div class="item-content">
        ...
        <li><a href="<%=Config.getWebDehecircle()%>/loadPage_dehecircle_card_list?r=<%=NumberUtils.randomNumbers(5)%>" class="item-link">
          <div class="item-content">
        ...
        <li><a href="<%=Config.getWebDehecircle()%>/loadPage_PH_password_list?r=<%=NumberUtils.randomNumbers(5)%>" class="item-link">
          <div class="item-content">
        ...
        <%--<li><a href="<%=Config.getWebRoot()%>/api/dehecircle/loadPage_score_list?customerId=<%=customerPersonalVO.getId()%>&r=<%=NumberUtils.randomNumbers(5)%>" class="item-link">--%>
          <%--<div class="item-content">--%>
            <%--<div class="item-media"><i class="icon material-icons">shopping_cart</i></div>--%>
            <%--<div class="item-inner">--%>
              <%--<div class="item-title">我的积分</div>--%>
              <%--<div class="item-after"><%=customerScoreVO.getAvailableScore()%></div>--%>
            <%--</div>--%>
          <%--</div></a>--%>
        <%--</li>--%>
      </ul>
