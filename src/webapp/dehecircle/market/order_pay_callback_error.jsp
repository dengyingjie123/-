        ...
        <div class="pages navbar-through">
            ...
            <div data-page="login-screen-embedded" class="page">
                <div class="page-content login-screen-content">
                    ...
                    <div style="margin: 0 auto; width:100%; text-align: center"><img src="<%=Config.getWebRoot()%>/include/images/error.png" style="width: 120px;height:120px;" /></div>
                    <br><br><br>
                    <div style="margin: 0 auto; width:100%; text-align: center">操作失败，如有疑问，请与我们联系</div>
                    <br><br><br>
